        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li <?php if (stripos($_SERVER['REQUEST_URI'], 'appointments') !== false) {
                            echo 'class="active"';
                        } ?>>
                        <a href="<?= URL_ADMIN ?>/appointments"><i class="fal fa-calendar"></i> <span class="nav-label">Compromissos</span></a>
                    </li>
